...
export SWANLAB_RUN_ID="prramse6blx2n5f5n18lm"
project_name='DAPO'

exp_name='DAPO_Qwen2.5_3b_instruct_with_prm_4_2'
...
ray start --head --port=6379 --num-gpus=3 --disable-usage-stats --temp-dir=$RAY_TMPDIR
rm -rf /tmp/ray 2>/dev/null || true
export RAY_ADDRESS="192.168.25.37:6379"
python -c "import ray; ray.init(address='192.168.25.37:6379'); r=ray.available_resources(); print(r); assert r.get('GPU',0)>=3"
...
python3 -m recipe.dapo.main_dapo \
    ...
    +actor_rollout_ref.resource_pool_name=actor_pool \
    +reward_model.resource_pool_name=rm_pool \
    +trainer.ray_resource_pool_sizes='[[2], [1]]' \
