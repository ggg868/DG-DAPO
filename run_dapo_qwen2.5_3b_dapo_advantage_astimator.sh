...
#export SWANLAB_RUN_ID="c80xmnxpdbz414ipq5vbr"
project_name='DAPO'
exp_name='DAPO-Qwen2.5-3b_dapo_advantage_astimator_17k'
...
# train_prompt_bsz=512 这个数会影响性能，7b最好调回512
...
NNODES=1 # 单台服务器
# Paths
MODEL_PATH="/data/maoyan.gan/my_verl/models/Qwen2.5-3B-base"
